  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16 flex flex-col gap-10">
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-xs uppercase tracking-widest text-[#FF2D78]" style={{ fontFamily: "'Courier New', monospace" }}>
          Sobre el artista
        </h2>
      ...
      <section className="flex flex-col gap-3">
        ...
        <ul className="flex flex-col gap-2">
          {artista.integrantes.map((i) => (
            <li key={i} className="text-gray-400 text-sm" style={{ fontFamily: "'Courier New', monospace" }}>
              — {i}
            </li>
          ))}
        </ul>
      ...
      <section className="border border-[#39FF14] px-6 py-4 flex flex-col gap-1">
        <span className="text-xs uppercase tracking-widest text-gray-500" style={{ fontFamily: "'Courier New', monospace" }}>
          Próxima fecha
        </span>
        <span className="text-[#39FF14] font-bold uppercase tracking-widest" style={{ fontFamily: "'Courier New', monospace" }}>
